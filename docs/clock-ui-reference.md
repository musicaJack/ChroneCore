...
```
┌──────────────────────────────────────── 320 ────────────────────────────────────────┐
│ 2026-05-26    Saturday                  (weather → bottom bar)                    │  ← 顶栏 ~36px
│                                                                                     │
│              ┌──┐┌──┐   ┌──┐┌──┐   ┌──┐┌──┐                                        │
...
| 适配项 | 建议 |
|--------|------|
| 顶栏 | 日期 `yyyy-MM-dd`；星期 **英文**（`chrone_time_weekday_en`） |
| 底栏 | 天气图标 + 英文现象 + 温度 + 城市（见 [clock-weather-layout.md](clock-weather-layout.md)） |
